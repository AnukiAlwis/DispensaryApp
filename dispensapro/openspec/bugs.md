...
- [] clinical notes saving to a different visit

## low

- [x] visit Notes not displying in the patient visits section
- [x] current consultation booking Date Time should be shown instead of last Visit date.


Scenarios to check :
- [] 
- [] edge case 1 : what if the patient not arrived? is it handled? how to handle 
- [] edge case 2 : what if the patient does not need medicine. how to skip Prescription builder part?